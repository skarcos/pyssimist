...
if __name__ == "__main__":
    ...
    # For OSV TSL has been verified with the following conditions: 1) Install UNSProotca64.rpm and download any of
    # root.pem, client.pem and server.pem from OSV to the test directory. Set "certificate" to appropriate filename.
    # Set subject_name to "localhost". or 2) Set certificate to None
    #
    # In general a valid certificate is needed. For the value of "subject_name" search for "Subject Alternative Name"
    # in output of 'openssl x509 -text -in <the certificate you will use>'
